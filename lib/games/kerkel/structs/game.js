...
J3O.structs('Game', function (app) {
    ...
    var gameplay_proto = (function () {
        ...
        Object.defineProperty(klass, 'players', {value: null, writable: true});
        Object.defineProperty(klass, 'on_turn', {value: null, writable: true});
    ...
    function create_stone(color, i_position, player) {
    ...
    Object.defineProperty(struct, 'createGameplay', {value: function (player1, player2) {
        var i;
        var klass = Object.create(gameplay_proto);

        klass.stones = [];
        for (i=0; i<5; i+=1) if (i!=2) klass.stones.push(create_stone(0xff5700, i, player1));
        for (i=10; i<15; i+=1) klass.stones.push(create_stone(0xaaaaaa, i));
        for (i=20; i<25; i+=1) if (i!=22) klass.stones.push(create_stone(0x004de9, i, player2));


        return klass;
    }});

    Object.defineProperty(struct, 'prepareGameplay', {value: function (game, local_player) {
        J3O.Board.removeAllStones(game);
        J3O.Board.layDownStones(game);
        J3O.Board.local_player = local_player;
        game.on_turn = game.players[0];
    }});
