...
var Objekt = (function () {
    var proto, klass, typy, typy_podlah, typy_specialni, typy_bloku;
    proto = {};
    klass = {};
    typy = {};
    ...
    Object.defineProperty(proto, 'sila_k_posunu', {value: NaN});
    ...
    Object.defineProperty(klass, 'proVsechnyTypySpecialni', {enumerable: true,
        value: function (f) {
            if (!typy_specialni) {
                var t, ti;
                typy_specialni = [];
                for (t in typy) {
                    if (typy.hasOwnProperty(t)) {
                        ti = parseInt(t);
                        if (!isNaN(ti) && ti<20) typy_specialni.push(t);
                    }
                }
            }
            var i;
            for (i=0;i<typy_specialni.length;i+=1) f(typy_specialni[i], typy[typy_specialni[i]]);
        }
    });

    Object.defineProperty(klass, 'proVsechnyTypyBloku', {enumerable: true,
        value: function (f) {
            if (!typy_bloku) {
                var t, ti;
                typy_bloku = [];
                for (t in typy) {
                    if (typy.hasOwnProperty(t)) {
                        ti = parseInt(t);
                        if (!isNaN(ti) && ti>49) typy_bloku.push(t);
                    }
                }
            }
            var i;
            for (i=0;i<typy_bloku.length;i+=1) f(typy_bloku[i], typy[typy_bloku[i]]);
        }
    });
