...
GUI.editor = (function () {
    ...
    var on_mousedown, on_mouseup, on_mousemove, on_mousewheel, on_keypress, get_pozice_mysi, move_camera;
    var mouse_held, down_pozice, up_pozice, current_pozice, oznaceni_pozic;
    var cam_radius, cam_inclination, cam_azimuth;
    ...
    Object.defineProperty(proto, 'zapnuty', {enumerable: true,
        set: function (val) {
            ...
            if (val) {
                ...
                jq_document.on('keypress', on_keypress);
                ...
                jq_document.off('keypress', on_keypress);
