...
GUI = (function () {
    ...
    Object.defineProperty(proto, 'posunKameruNadStred', {enumerable: true,
        value: function () {
            if (!stred) stred = new THREE.Vector3(0, 0, 0);
            platno.camera.position = stred;
            platno.camera.position.z = 50;
            platno.camera.rotations = new THREE.Vector3(0, 0, 0);

            platno.camera.lookAt(stred);
            platno.redraw();
        }
    });
